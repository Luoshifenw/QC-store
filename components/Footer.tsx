      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/pages/shipping" className="text-sm text-neutral-500 hover:text-neutral-900 transition">Shipping & Returns</Link></li>
              <li><Link href="/pages/size-guide" className="text-sm text-neutral-500 hover:text-neutral-900 transition">Size Guide</Link></li>
              <li><Link href="/pages/faq" className="text-sm text-neutral-500 hover:text-neutral-900 transition">FAQ</Link></li>
              <li><Link href="/pages/contact" className="text-sm text-neutral-500 hover:text-neutral-900 transition">Contact Us</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-neutral-500 mb-4">Subscribe for exclusive offers and new arrivals.</p>
            <form className="flex">
              <input
                type="email"
                placeholder="Your email"
                className="flex-1 px-4 py-2 text-sm border border-neutral-200 focus:border-neutral-400 focus:outline-none"
              />
              <button className="px-4 py-2 bg-neutral-900 text-white text-sm hover:bg-neutral-800 transition">
                Join
              </button>
            </form>
          </div>
